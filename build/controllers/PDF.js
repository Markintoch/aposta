...
class PDF {
    ...
    async generatePDF(pdfData) {
        try {
            //INITIAL CONFIG
            let marginLeft = 30;
            let imagenOptions = { width: 170 };
            let tableOptions = { width: 550 };
            let footerOptions = { width: 560, height: 170 };
            let font = 11;
            let descriptionOptions = { width: 550, align: 'justify' };
    ...
    async primerPaginaPDF(pdfData) {
        let tablaPagos = this.tablaPagos(pdfData);
        let pdf_contenido = `<html>
            <head>
    ...
    async segundaPaginaPDF(pdfData) {
